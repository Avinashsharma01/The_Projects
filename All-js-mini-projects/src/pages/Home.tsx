...
const Home = () => {
    ...
    return (
        <div className="main ml-5 mr-5 sm:ml-5 sm:mr-5 md:ml-10 md:mr-10 md:mb-10 md:mt-2">
            <div className="heading md:mb-2 mt-4 ">
                <h1 className="bg-[#0FB0DE] text-white uppercase p-3 text-center text-2xl font-semibold rounded-sm">
                    Here is some javascript mini projects
                </h1>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 w-full mx-auto px-2 py-6">
                {MyData.map((item, index) => (
                    <div
                        key={index}
                        className="box bg-slate-600 rounded-lg overflow-hidden shadow-lg transform transition duration-300 hover:scale-105"
                    >
                        <div className="img h-2/3 w-full">
                            <img
                                src={item.imageULR}
                        ...
                        <div className="desc w-full h-1/3 flex justify-center items-center p-4">
                            <a
                                href={item.Link}
                                className="bg-blue-700 text-white py-2 px-4 rounded-full text-center w-full transition duration-300 hover:bg-blue-800 hover:shadow-lg"
                                target="_blank"
